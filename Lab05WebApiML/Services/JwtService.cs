...
public class JwtService : IJwtService
{
    ...
    // Constructor con inyección de IHttpContextAccessor para obtener IP correctamente
    public JwtService(
        ...
        IHttpContextAccessor httpContextAccessor)
    {
        ...
        _jwtAudience = configuration["JWT:Audience"] ?? "Lab05WebApiMLUsers";
    ...
    public async Task<AuthResponseDto> GenerateJwtToken(ApplicationUser user)
    {
        try
        {
            ...
            var claims = new List<Claim>
            {
                ...
                new Claim("FirstName", user.Nombres ?? string.Empty),
                new Claim("LastName", user.Apellidos ?? string.Empty),
        ...
        catch (Exception ex)
        {
            ...
            return new AuthResponseDto
            {
                ...
                Errors = new List<string> { "Ocurrió un error durante la autenticación" }
            };
        }
    }
    ...
    private string GetClientIp()
    {
        ...
        {
            _logger.Info("Client IP Unknown");
        }
        return "Unknown";
    }
